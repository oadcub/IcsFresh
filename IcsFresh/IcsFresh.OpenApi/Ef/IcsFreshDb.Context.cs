...
namespace IcsFresh.OpenApi.Ef
{
    ...
    public partial class IcsFreshDbEntities : DbContext
    {
        public IcsFreshDbEntities()
            : base("name=IcsFreshDbEntities")
        {
        }
        ...
        public virtual DbSet<UnitMeter> UnitMeters { get; set; }
        public virtual DbSet<vOrderSummary> vOrderSummaries { get; set; }
    }
}
